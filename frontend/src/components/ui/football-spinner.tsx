    ...
    <div className={`${sizeClasses[size]} ${className}`}>
      <div className="relative w-full h-full">
        ...
        <div className="absolute inset-0 animate-pulse">
          <div className="w-full h-full rounded-full bg-white/10 blur-sm"></div>
        </div>
      </div>
    </div>
  );
...
// Alternative simpler soccer ball spinner
export function SimpleFootballSpinner({
  size = "md",
  className = "",
}: FootballSpinnerProps) {
  const sizeClasses = {
  ...
  return (
    <div className={`${sizeClasses[size]} ${className}`}>
      <div className="relative w-full h-full">
        {/* Soccer ball shape */}
        <div className="absolute inset-0 animate-spin">
          <div className="w-full h-full bg-white rounded-full relative overflow-hidden border-2 border-gray-800 dark:border-gray-600">
            {/* Soccer ball pattern - simplified */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-3/4 h-3/4 bg-gray-800 dark:bg-gray-600 rounded-full flex items-center justify-center">
                <div className="w-1/2 h-1/2 bg-white rounded-full"></div>
              </div>
            </div>
            {/* Additional pattern lines */}
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-full h-0.5 bg-gray-800 dark:bg-gray-600 transform rotate-45"></div>
            </div>
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-full h-0.5 bg-gray-800 dark:bg-gray-600 transform -rotate-45"></div>
            </div>
