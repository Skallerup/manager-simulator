...
export class LeagueService {
  ...
  static calculateBotPlayerStats(level: number, position: string) {
    ...
    const speed = Math.max(1, Math.min(100, baseRating + Math.floor(Math.random() * variation * 2) - variation));
    const shooting = Math.max(1, Math.min(100, baseRating + Math.floor(Math.random() * variation * 2) - variation));
    const passing = Math.max(1, Math.min(100, baseRating + Math.floor(Math.random() * variation * 2) - variation));
    const defending = Math.max(1, Math.min(100, baseRating + Math.floor(Math.random() * variation * 2) - variation));
    const stamina = Math.max(1, Math.min(100, baseRating + Math.floor(Math.random() * variation * 2) - variation));
    const reflexes = Math.max(1, Math.min(100, baseRating + Math.floor(Math.random() * variation * 2) - variation));
